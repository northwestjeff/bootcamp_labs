# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-30 22:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cov_id', models.CharField(default='Covenant ID', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covenants', models.ForeignKey(default='No Covenants', on_delete=django.db.models.deletion.CASCADE, to='pages.Covenants')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('loans', models.ForeignKey(default='No Loans', on_delete=django.db.models.deletion.CASCADE, to='pages.Loan')),
            ],
        ),
        migrations.AddField(
            model_name='organization',
            name='portfolio',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='pages.Portfolio'),
        ),
        migrations.AddField(
            model_name='noncompliantportfolio',
            name='loans',
            field=models.ForeignKey(default='Default NC Loans', on_delete=django.db.models.deletion.CASCADE, to='pages.Portfolio'),
        ),
        migrations.AddField(
            model_name='borrower',
            name='loans',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.Loan'),
        ),
    ]
